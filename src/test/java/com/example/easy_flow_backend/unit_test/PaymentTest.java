...
public class PaymentTest {
    ...
    public void addOwner(){
        Owner cairoGovernment = new Owner("Cairo Government2", "government@government.gov", "0000 0000 0000 0000");
        ownerRepo.save(cairoGovernment);
        List<Owner> owners =ownerRepo.findAll();
        boolean found = false;
        for(Owner owner : owners){
            if(owner.getName().equals("Cairo Government2")){
                found = true;
                break;
            }
        }
    ...
    public void addOwnerFail(){
        ...
        boolean found = false;
        for(Owner owner : owners){
            if(owner.getName().equals("Cairo Government3")){
                found = true;
                break;
            }
        }
    ...
    Owner addMockOwner(String name){
        Owner owner = new Owner(name, MessageFormat.format("{0}@gmail.com", name), "0000 0000 0000 0000");
    ...
    void line2Init() throws ParseException {
